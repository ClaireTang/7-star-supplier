<template>
	<view class="content">
		<uni-swipe-action-fix   @click="removeM" v-for="(obj,index) in list"  :key="index"   :options="obj.ID"  >
			<view class="contBox">
				...
				<view class="goodBox">
					<view>
						<view>{{obj.name}}</view>
						<view class="fz12 color-grey">{{obj.desc}}</view>
					</view>
					<view class="fz12 color-grey guige">
						<!-- <view class="fz12">{{obj.price}}/{{obj.danwei}}</view> -->
						<view>规格：斤，1天：（￥15）</view>
						<view>规格：斤，2天：（￥10）</view>
					</view>
					<!-- <view class="countBox">
						<view class="sign" @click="signCount(obj.ID)">
							<image src="~@/static/bbh-shopCar/icon/signf.png"  v-if="obj.count>1"></image>
						...
						<view class="add" @click="addCount(obj.ID)">
							<image src="~@/static/bbh-shopCar/icon/addf.png"   v-if="obj.stock>obj.count"></image>
							<image src="~@/static/bbh-shopCar/icon/adde.png"   v-if="obj.stock==obj.count"></image>
						</view>
					</view> -->
				</view>
			</view>
		</uni-swipe-action-fix>
...
<script>
	import uniSwipeActionFix from '@/components/uni-swipe-action/uni-swipe-action-fix.vue';
	export default {
		name : "shopCar",
		props:{
			list : Array
